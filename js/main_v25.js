...
const LANG = {
  en: {
    ...
    'hero.subtitle': 'Bridging satellite data, weather forecasts, and AI crop models to deliver actionable, localized advisories for smallholder farmers across India.',
    'hero.cta': 'Explore Dashboard →', 'hero.cta2': 'Get Crop Advice',
    'hero.info': 'Live data • All Indian districts • Updated every 30min',
    ...
    'index.feat1.title': 'AI Crop Forecasting', 'index.feat1.desc': 'ML-powered suitability scoring for 22 major crops. Matches soil type, season, and climate data to recommend the best variety for your farm.',
    ...
    'index.feat6.title': 'Hyper-Local Analytics', 'index.feat6.desc': 'Down to district-level climate granularity. 7-day forecasts, crop calendars, and soil health dashboards for all Indian districts.',
    ...
    'index.districts.tag': '📍 Coverage', 'index.districts.title': 'Pan-India Coverage', 'index.districts.desc': 'Complete climate intelligence across every district in India',
    ...
    'advisor.subtitle': 'Our advanced Neural Network (MLP) model (<strong class="text-green">94.2% accuracy</strong>) analyses your soil health, climate, and irrigation capacity to recommend the best crops for maximum yield.',
    'wizard.step1': 'Location & Soil', 'wizard.step2': 'Season & Water', 'wizard.step3': 'Get Report',
    'model.loading': '⏳ Loading AI model...', 'model.crops': '🌾 22 Crop Classes', 'model.samples': '📊 2.2K Training Samples', 'model.features': '4 Features',
    ...
    'dash.tip.title': '💡 Seasonal Tip',
    'dash.month.0': 'January', 'dash.month.1': 'February', 'dash.month.2': 'March', 'dash.month.3': 'April',
    'dash.month.4': 'May', 'dash.month.5': 'June', 'dash.month.6': 'July', 'dash.month.7': 'August',
    'dash.month.8': 'September', 'dash.month.9': 'October', 'dash.month.10': 'November', 'dash.month.11': 'December',
    'dash.tip.0': 'January is ideal for frost protection for vegetables. Apply light irrigation at night.',
    'dash.tip.1': 'February: Apply second top-dressing of Urea to Wheat. Monitor for yellow rust.',
    'dash.tip.2': 'March is ideal for Rabi harvest & early Kharif preparation. Check soil moisture.',
    'dash.tip.3': 'April: Peak Wheat harvest. Ensure proper drying. Prepare for Zaid crops like Moong.',
    'dash.tip.4': 'May: Prepare land for Rice nursery. Repair irrigation channels before monsoon.',
    'dash.tip.5': 'June: Sowing of Kharif crops (Rice, Maize, Soyabean) with first monsoon rains.',
    'dash.tip.6': 'July: Complete Rice transplanting. Monitor for weeds and apply herbicides if needed.',
    'dash.tip.7': 'August: Top-dressing for Rice. Ensure proper drainage to avoid waterlogging.',
    'dash.tip.8': 'September: Harvest early Rice varieties. Prepare land for Rabi season (Torai/Lahi).',
    'dash.tip.9': 'October: Peak Rice harvest. Sowing of Wheat and Mustard starts in second fortnight.',
    'dash.tip.10': 'November: Complete Wheat sowing. High risk of early frost in mountain districts.',
    'dash.tip.11': 'December: First irrigation for Wheat (CRI stage). Protect orchards from cold.',
    ...
    'risk.title': 'District Risk Intelligence Map', 'risk.map': '🗺️ India Risk Map', 'risk.desc': 'Real-time climate risk assessment for all Indian districts using satellite data, weather feeds, and geological surveys.',
    ...
    'footer.copy': '© 2026 VrikshVera',    'footer.stats': '🤖 MLP Model · 94.20% accuracy · 2,200 training samples · 22 crop classes',
    ...
    'dash.sub.temp': 'Current Avg', 'dash.sub.humidity': 'Relative %', 'dash.sub.rainfall': 'Live Hourly mm', 'dash.sub.wind': 'km/h',
    ...
    'alert.high.t1': 'Extreme Rainfall Warning (Forecast)', 'alert.high.m1': 'Heavy rainfall (>50mm) forecast in 36 hrs. Drain fields immediately.',
    ...
    'label.Nitrogen': 'Nitrogen', 'label.Phosphorus': 'Phosphorus', 'label.Potassium': 'Potassium',
    'label.Temp': 'Temp', 'label.Humidity': 'Humidity', 'label.ph': 'pH', 'label.Rainfall': 'Rainfall',
    'btn.fertilizer': 'Get Fertilizer Advice', 'label.UnifiedML': 'Unified ML',
    'fert.modal.title': 'Fertilizer Recommendation for {crop}', 'fert.modal.subtitle': 'AI-powered, soil N-P-K analysis',
    'fert.modal.note': 'This advice is based on your current soil N-P-K levels, soil type, and crop requirements. Consult a local agronomist for precise dosage.',
    'btn.gotit': '✅ Got it!',
    ...
    'footer.l.uttarakhand': 'Pan-India', 'footer.l.districts': 'All Districts', 'footer.l.satellite': 'Satellite Data',
    ...
    'bot.welcome.title': 'Welcome to VrikshVera Chat',
    'bot.welcome.desc': 'Expert agriculture advice tailored for Indian farmers. Upload images of your crops to detect diseases instantly.',
    ...
    'risk.insurance.desc': 'Available protection schemes for climate-risk farmers across India',
  ...
  hi: {
    ...
    'hero.subtitle': 'भारत भर के लघु किसानों के लिए सटीक सलाह देने के लिए उपग्रह डेटा, मौसम पूर्वानुमान और एआई फसल मॉडल का उपयोग।',
    'hero.cta': 'डैशबोर्ड देखें →', 'hero.cta2': 'फसल सलाह लें',
    'hero.info': 'लाइव डेटा • भारत के सभी जिले • हर 30 मिनट में अपडेट', 'hero.scroll': 'खोजने के लिए स्क्रॉल करें',
    ...
    'index.feat1.title': 'एआई फसल पूर्वानुमान', 'index.feat1.desc': '22 प्रमुख फसलों के लिए एमएल-पावर्ड उपयुक्तता स्कोरिंग। आपके खेत के लिए सर्वोत्तम किस्म की सिफारिश करने के लिए मिट्टी के प्रकार, मौसम और जलवायु डेटा का मिलान करता है।',
    ...
    'index.feat6.title': 'हाइपर-लोकल एनालिटिक्स', 'index.feat6.desc': 'जिला-स्तर की जलवायु ग्रैन्युलैरिटी तक। भारत के सभी जिलों के लिए 7-दिवसीय पूर्वानुमान, फसल कैलेंडर और मिट्टी स्वास्थ्य डैशबोर्ड।',
    ...
    'index.districts.tag': '📍 कवरेज', 'index.districts.title': 'पैन-इंडिया कवरेज', 'index.districts.desc': 'भारत के हर जिले में पूर्ण जलवायु इंटेलिजेंस',
    ...
    'advisor.subtitle': 'हमारा उन्नत न्यूरल नेटवर्क (MLP) मॉडल (<strong class="text-green">94.2% सटीकता</strong>) आपकी मिट्टी के स्वास्थ्य, जलवायु और सिंचाई क्षमता का विश्लेषण करके सर्वोत्तम फसलों की सिफारिश करता है।',
    'wizard.step1': 'स्थान और मिट्टी', 'wizard.step2': 'सीजन और पानी', 'wizard.step3': 'रिपोर्ट प्राप्त करें',
    'model.loading': '⏳ एआई मॉडल लोड हो रहा है...', 'model.crops': '🌾 22 फसल श्रेणियां', 'model.samples': '📊 2.2K ट्रेनिंग सैंपल', 'model.features': '4 विशेषताएं',
    ...
    'dash.tip.title': '💡 मौसमी सुझाव',
    'dash.month.0': 'जनवरी', 'dash.month.1': 'फरवरी', 'dash.month.2': 'मार्च', 'dash.month.3': 'अप्रैल',
    'dash.month.4': 'मई', 'dash.month.5': 'जून', 'dash.month.6': 'जुलाई', 'dash.month.7': 'अगस्त',
    'dash.month.8': 'सितंबर', 'dash.month.9': 'अक्टूबर', 'dash.month.10': 'नवंबर', 'dash.month.11': 'दिसंबर',
    'dash.tip.0': 'जनवरी सब्जियों के पाले से बचाव के लिए आदर्श है। रात में हल्की सिंचाई करें।',
    'dash.tip.1': 'फरवरी: गेहूं में यूरिया की दूसरी टॉप-ड्रेसिंग करें। पीली रतुआ (yellow rust) की निगरानी करें।',
    'dash.tip.2': 'मार्च रबी की कटाई और शुरुआती खरीफ की तैयारी के लिए आदर्श है। मिट्टी की नमी की जांच करें।',
    'dash.tip.3': 'अप्रैल: गेहूं की कटाई का चरम समय। उचित सुखाने को सुनिश्चित करें। मूंग जैसी जैद फसलों के लिए तैयारी करें।',
    'dash.tip.4': 'मई: धान की नर्सरी के लिए जमीन तैयार करें। मानसून से पहले सिंचाई चैनलों की मरम्मत करें।',
    'dash.tip.5': 'जून: मानसून की पहली बारिश के साथ खरीफ फसलों (धान, मक्का, सोयाबीन) की बुआई।',
    'dash.tip.6': 'जुलाई: धान की रोपाई पूरी करें। खरपतवारों की निगरानी करें और यदि आवश्यक हो तो शाकनाशी का उपयोग करें।',
    'dash.tip.7': 'अगस्त: चावल के लिए टॉप-ड्रेसिंग। जलभराव से बचने के लिए उचित जल निकासी सुनिश्चित करें।',
    'dash.tip.8': 'सितंबर: अगेती धान की किस्मों की कटाई। रबी सीजन (तोरई/लाही) के लिए जमीन तैयार करें।',
    'dash.tip.9': 'अक्टूबर: धान की कटाई का चरम समय। दूसरे पखवाड़े में गेहूं और सरसों की बुवाई शुरू होती है।',
    'dash.tip.10': 'नवंबर: गेहूं की बुवाई पूरी करें। पहाड़ी जिलों में शुरुआती पाले का उच्च जोखिम।',
    'dash.tip.11': 'दिसंबर: गेहूं की पहली सिंचाई (CRI चरण)। बागों को ठंड से बचाएं।',
    ...
    'risk.title': 'जिला जोखिम खुफिया मानचित्र', 'risk.map': '🗺️ भारत जोखिम मानचित्र', 'risk.desc': 'सैटेलाइट डेटा, मौसम फीड और भूगर्भीय सर्वेक्षणों का उपयोग करके भारत के सभी जिलों के लिए वास्तविक समय जलवायु जोखिम मूल्यांकन।',
    ...
    'footer.copy': '© 2026 वृक्ष-वेरा', 'footer.stats': '🤖 एमएलपी मॉडल · 94.2% सटीकता · 2,200 ट्रेनिंग सैंपल · 22 फसलें',
    ...
    'dash.sub.temp': 'वर्तमान औसत', 'dash.sub.humidity': 'सापेक्ष %', 'dash.sub.rainfall': 'लाइव प्रति घंटा (मिमी)', 'dash.sub.wind': 'किमी/घंटा',
    ...
    'alert.high.t1': 'भारी वर्षा की चेतावनी (पूर्वानुमान)', 'alert.high.m1': '36 घंटों में भारी वर्षा (>50मिमी) का पूर्वानुमान। खेतों की तुरंत निकासी करें।',
    ...
    'label.Nitrogen': 'नाइट्रोजन', 'label.Phosphorus': 'फास्फोरस', 'label.Potassium': 'पोटेशियम',
    'label.Temp': 'तापमान', 'label.Humidity': 'नमी', 'label.ph': 'pH', 'label.Rainfall': 'वर्षा',
    'btn.fertilizer': 'खाद संबंधी सलाह लें', 'label.UnifiedML': 'यूनिफाइड एमएल',
    'fert.modal.title': '{crop} के लिए खाद की सिफारिश', 'fert.modal.subtitle': 'एआई-संचालित, मिट्टी का एन-पी-के विश्लेषण',
    'fert.modal.note': 'यह सलाह आपके वर्तमान मिट्टी के एन-पी-के स्तर, मिट्टी के प्रकार और फसल की आवश्यकताओं पर आधारित है। सटीक खुराक के लिए स्थानीय कृषि विशेषज्ञ से परामर्श लें।',
    'btn.gotit': '✅ ठीक है!',
    ...
    'footer.l.uttarakhand': 'पैन-इंडिया', 'footer.l.districts': 'सभी जिले', 'footer.l.satellite': 'उपग्रह डेटा',
    ...
    'bot.welcome.desc': 'भारतीय किसानों के लिए विशेषज्ञ कृषि सलाह। रोगों का तुरंत पता लगाने के लिए अपनी फसलों की तस्वीरें अपलोड करें।',
    ...
    'risk.insurance.desc': 'भारतीय किसानों के लिए उपलब्ध सुरक्षा योजनाएं',
